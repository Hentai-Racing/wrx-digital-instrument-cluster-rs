/// Generated code from build.rs::generate_can_data_code()!
                ...
                thread::spawn(move || {
                    while running.load(Ordering::SeqCst) {
                        ...
                        if let Some(frame) = CanDataFrame::new(
                            ...
                            socket
                                .write_frame::<CanDataFrame>(&frame)
                        ...
                        let n_accelerator_pedal_max_sw = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let steering_angle = rand::thread_rng()
                            .gen_range(
                                wrx_2018::Steering::STEERING_ANGLE_MIN..=wrx_2018::Steering::STEERING_ANGLE_MAX,
                            );
                        let steering_frame = wrx_2018::Steering::new(steering_angle)
                            .expect("Failed to create frame");
                        if let Some(frame) = CanDataFrame::new(
                            steering_frame.id(),
                            steering_frame.data(),
                        ...
                        let driver_seatbelt_warning_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let cruise_control_set_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let dashstate2verify_frame = wrx_2018::DashState2Verify::new(
                                units,
                            )
                            .expect("Failed to create frame");
                        if let Some(frame) = CanDataFrame::new(
                        ...
                        let oil_pressure_warning_light_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        let check_engine_light_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let srs_system_warning_light_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let tpms_warning_light_enabled = rand::thread_rng()
                            .gen_bool(0.5);
                        ...
                        let dimmer_max_brightness_enable = rand::thread_rng()
                            .gen_bool(0.5);
